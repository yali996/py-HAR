...
# number of labels for miml
__C.TRAIN.NUM_LABELS = 1
...
# ratio for cascading
__C.TRAIN.CASCADE_RATIO = 0.3

# 
__C.TRAIN.HAS_MIL = True
__C.TRAIN.NMS_THRESH = 0.5
...
def get_output_dir_ext(imdb_name, net=None):
    """Return the directory where experimental artifacts are placed.
    If the directory does not exist, it is created.
