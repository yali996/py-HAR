...
def add_bbox_regression_targets(roidb):
    ...
    # save the means and stds, revised by Yali Li
    mean_and_stds = np.hstack((means, stds) )
    with open('mean_and_stds.pkl','w') as f:
        pickle.dump(mean_and_stds, f, pickle.HIGHEST_PROTOCOL)
