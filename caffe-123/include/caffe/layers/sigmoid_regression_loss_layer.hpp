#ifndef CAFFE_SIGMOID_REGRESSION_LOSS_LAYER_HPP_
#define CAFFE_SIGMOID_REGRESSION_LOSS_LAYER_HPP_
...
class SigmoidRegressionLossLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidRegressionLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SigmoidRegressionLoss"; }
...
#endif  // CAFFE_SIGMOID_REGRESSION_LOSS_LAYER_HPP_
