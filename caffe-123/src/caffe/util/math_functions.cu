...
template <>
void caffe_gpu_strided_dot<float>(const int n, const float* x, const int incx, const float* y, const int incy,
    float* out) {
  CUBLAS_CHECK(cublasSdot(Caffe::cublas_handle(), n, x, incx, y, incy, out));
}

template <>
void caffe_gpu_strided_dot<double>(const int n, const double* x, const int incx, const double* y, const int incy,
    double * out) {
